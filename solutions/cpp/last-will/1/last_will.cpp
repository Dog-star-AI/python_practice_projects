...
int assemble_account_number(int secret_modifier){
    ...
    int assembled_account_number = (garcia::bank_number_part(secret_modifier) + zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier));

    return assembled_account_number;
    }
int assemble_code(){
    int red_sum = garcia::red::code_fragment() + zhang::red::code_fragment() + khan::red::code_fragment();
    int blue_sum = garcia::blue::code_fragment() + zhang::blue::code_fragment() + khan::blue::code_fragment();
